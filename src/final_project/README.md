...
My url on hf
https://huggingface.co/spaces/beenlanced/Final_Assignment_Template

Run Locally
https://huggingface.co/learn/agents-course/en/unit0/onboarding#step-5-running-models-locally-with-ollama-in-case-you-run-into-credit-limits

have to run
huggingface-cli login at the CLI to test locally use your HF TOKEN
...
### Working With DuckDuckGo Search Tool

Future PRoject
https://www.youtube.com/watch?v=3ZDeqTIXBPM
walks through all the different steps
